...
- Speaker: _Abhishek Aggarwal_
- Timestamp: _18:21_
- Text: _Hi. How is everyone doing?_
...
| T4.2 | No Transcript   | 1. Load a tl;dv video _without_ transcript (or before it loads).<br>2. Click Download. | Alert: "No transcript data found"                           |        |
