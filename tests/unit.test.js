...
const { processTranscript, scrapeTranscriptFromPage } = require('../assets/js/popup.js');
...
describe('Summary Generator Unit Tests', () => {
    ...
    describe('processTranscript', () => {
        ...
        test('should copy correctly formatted TXT to clipboard', async () => {
            ...
            const expectedContent = "10:00 Alice :: Hi there.\n10:01 Bob :: Hello Alice.";
        ...
        test('should create correct CSV content for download', () => {
            // We need to spy on Blob constructor, but JSDOM implementation is tricky.
            // Instead we verify the flow calls URL.createObjectURL with SOME blob

            processTranscript(mockData, 'csv', 'download', 'meeting_id');

            expect(global.URL.createObjectURL).toHaveBeenCalled();
            // In a real environment we'd inspect the Blob content, but here we verify flow
            const call = document.body.appendChild.mock.calls[0][0]; // The anchor element
